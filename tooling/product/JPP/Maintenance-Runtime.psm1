...
#
# File      : tooling/product/JPP/Maintenance-Runtime.psm1
# Programme : PP-001
# WorkPack  : WP-003
# Unit      : EU-008
#
...
$requiredCommands = @(
    'Invoke-JPPMaintenanceDomain'
    'Invoke-JPPServiceEvent'
    'Invoke-JPPMaintenanceSchedule'
    'Invoke-JPPServiceHistory'
    'Invoke-JPPMaintenanceSearch'
    'Invoke-JPPMaintenanceDashboard'
    'Invoke-JPPMaintenanceIntelligence'
)
