...
#
# File      : tooling/product/JPP/Parts-Runtime.psm1
# Programme : PP-001
# WorkPack  : WP-002
# Unit      : EU-008
#
...
$requiredCommands = @(
    'Invoke-JPPPartsDomain'
    'Invoke-JPPPartCompatibility'
    'Invoke-JPPSupplierDomain'
    'Invoke-JPPSupplierPricing'
    'Invoke-JPPPartsSearch'
    'Invoke-JPPPartsDashboard'
    'Invoke-JPPPartsIntelligence'
)

foreach ($command in $requiredCommands) {
    if (-not (Get-Command -Name $command -ErrorAction SilentlyContinue)) {
        throw "Required Parts Platform command is unavailable: $command"
    }
}
