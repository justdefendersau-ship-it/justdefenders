...
#
# File      : tooling/product/JPP/Vehicle-Intelligence-Runtime.psm1
# Programme : PP-001
# WorkPack  : WP-004
# Unit      : EU-008
#
...
$requiredCommands = @(
    'Invoke-JPPVehicleIntelligenceDomain'
    'Invoke-JPPVehicleHealth'
    'Invoke-JPPVehicleReliability'
    'Invoke-JPPFailureHistory'
    'Invoke-JPPVehicleIntelligenceSearch'
    'Invoke-JPPVehicleIntelligenceDashboard'
    'Invoke-JPPVehicleIntelligence'
)

foreach ($command in $requiredCommands) {
    if (-not (Get-Command -Name $command -ErrorAction SilentlyContinue)) {
        throw "Required Vehicle Intelligence Platform command is unavailable: $command"
    }
}
